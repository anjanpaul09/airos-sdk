...
// Function prototype for netconf_process_set_msg()
void netconf_process_set_msg(const char *buffer);

// Function to read the file and pass it to netconf_process_set_msg()
void read_setjson_and_process() {
    ...
    netconf_process_set_msg(buffer);
