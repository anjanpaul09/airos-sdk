...
void sm_device_report(EV_P_ ev_timer *w, int revents)
{
    ...
    sm_device_ctx_t                *device_ctx = (sm_device_ctx_t *) w->data;
    device_report_data_t           *report_ctx = &device_ctx->report;
    sm_stats_request_t             *request_ctx = &device_ctx->request;
...
{
    sm_device_ctx_t                *device_ctx = &g_sm_device_ctx;
    sm_stats_request_t             *request_ctx = &device_ctx->request;
    device_report_data_t           *report_ctx = &device_ctx->report;
    ev_timer                       *report_timer = &device_ctx->report_timer;
