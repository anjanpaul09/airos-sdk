...
/* Netlink family id used by airdpi */
#ifndef NETLINK_USER
...
struct airpro_coplane {
    ...
    /* consolidated from air_vif */
    struct client_registry reg;
    struct domain_entry top_domains[MAX_DOMAINS];
    spinlock_t domain_lock;
    DECLARE_HASHTABLE(blocked_domains, 8);
...
/* Generic spin macros used by client registry (from air_vif.h) */
...
/* simple string hash (moved from air_vif.h) */
