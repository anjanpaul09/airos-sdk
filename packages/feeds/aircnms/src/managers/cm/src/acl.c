...
bool cm_handle_add_blacklist(char *mac)
{
...
bool cm_handle_add_blacklist_ssid(char *mac, char *target_ssid)
{
    char wlan_ifname[8][16];
    num_iface = 0;
...
bool cm_handle_remove_blacklist(char *mac)
{
    char wlan_ifname[8][16];
    num_iface = 0;
...
bool cm_handle_add_whitelist(char *mac)
{
    char wlan_ifname[8][16];
    char target_ssid[64];
    num_iface = 0;
...
bool cm_handle_add_whitelist_ssid(char *mac, char *target_ssid)
{
    char wlan_ifname[8][16];
    num_iface = 0;
...
bool cm_handle_remove_whitelist(char *mac)
{
    char wlan_ifname[8][16];
    num_iface = 0;
